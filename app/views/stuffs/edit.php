    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <div class="card card-body bg-light my-auto">
                ...
                <?php elseif ($data['id_err'] !== '') : ?>
                <div class="alert alert-danger"><?php echo $data['id_err']; ?></div>
                <?php endif; ?>
                <form action="<?php echo URLROOT; ?>/stuffs/edit/<?php echo $data['id']; ?>" method="post" accept-charset="UTF-8">
                    ...
                    <div class="row">
                        <div class="col">
                            <input type="submit" value="Edit stuff" class="btn btn-success btn-block">
                        </div>
                        <div class="col">
